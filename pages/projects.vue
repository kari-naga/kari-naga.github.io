  ...
  <Content :title="title">
    <div class="flex flex-col items-center gap-2">
      ...
      <p class="max-w-prose">
        ...
        Check the linked Github repository for more information.
      </p>
    </div>
    <div class="flex flex-col items-center gap-2">
      <h2 class="text-xl">
      ...
      <img src="~/assets/img/synthszr.png" alt="Synthszr UI" class="max-w-2xl w-full h-auto" width="1171" height="454" />
    </div>
  </Content>
</template>
